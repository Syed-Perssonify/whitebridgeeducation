...
export function WorldMap({
  ...
  const labelBoxClasses = useMemo(
    () =>
      [
        ...
        "shadow-md border border-black/5 whitespace-nowrap",
        labelClassName,
      ]
        .filter(Boolean)
        .join(" "),
  ...
  const labelDimensions = { width: 140, height: 32 };
              ...
              {loop && (
                ...
                >
                  <animate
                    ...
                    keyTimes={`0;${startTime};${endTime};${resetTime};1`}
                    calcMode="linear"
            ...
            <g key={`points-group-${i}`}>
              ...
              <g key={`start-${i}`}>
                ...
                {/* {showLabels && dot.start.label && (
                  ...
                  >
                    <foreignObject
                      x={startPoint.x - labelDimensions.width / 2}
                      y={startPoint.y - labelDimensions.height - 12}
                ...
                {showLabels && dot.end.label && (
                  ...
                  >
                    <foreignObject
                      ...
                      y={endPoint.y - labelDimensions.height - 24}
                      width={labelDimensions.width}
                      height={labelDimensions.height}
                      className="overflow-visible"
                    >
